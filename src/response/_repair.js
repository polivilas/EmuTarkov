...
function main(info) {
    ...
    let trader_var = trader.get(info.tid); // trader informations from Trader table
    let repairCurrency = trader_var.data.repair.currency;
    let repairRate = (trader_var.data.repair.price_rate === 0) ? 1 : (trader_var.data.repair.price_rate / 100 + 1);
