...
{	
	...
	var presets = 
	{
		Head:["wild_head_1","wild_head_2","wild_head_3","wild_dealmaker_head","wild_dealmaker_head","head_boss_killa","bear_head"],
		...
		pistols:["5b3b713c5acfc4330140bd8d","5a7ae0c351dfba0017554310","576a581d2459771e7b1bc4f1","59f98b4986f7746f546d2cef","571a12c42459771f627b58a0","5abccb7dd8ce87001773e277","5448bd6b4bdc2dfc2f8b4569","579204f224597773d619e051","56e0598dd2720bb5668b45a6",]
	}
	...
	{	
		for (var i = 1; i <= params.Limit; i++) //generate as many as the game request
		{
			...
			BotBase.Info.Voice = "Scav_" + getRandomIntEx(6);
			...
			var Weapon = weaponPresets.data[ Object.keys(weaponPresets.data)[getRandomIntEx(Object.keys(weaponPresets.data).length)] ]; //lol javascript sucks	
		    ...
		    Weapon._items.forEach(function(item)
		    {
		    	...
		    	else //add mods or vital parts
		    	{
					...
					{	
						for(var magazine in itemJSON )
						{
							if (item._tpl == itemJSON[magazine]._id) //find the magazine
							{	
								//then find what ammo i can put in 
								var ammo_filter = itemJSON[magazine]._props.Cartridges[0]._props.filters[0].Filter; //Nice api BSG ! 
								var mag_size = itemJSON[magazine]._props.Cartridges[0]._max_count;  //how many cartridges i can put in
			...
			if(getRandomIntEx(100) <= 40) 
			{
				...
				if(getRandomIntEx(100) <= 20) //20% percent chance we add something inside
				{
					//to be implemented...
				}
			}	
